...
const features = [
  {
    ...
    title: "No chain",
    description:
      "We purchase directly. There is no chain beneath us that can collapse and take the sale with it.",
  ...
  },
  {
    ...
    description:
      "Once we exchange, we complete. The estate plans around a fixed date, not a buyer who might withdraw.",
  ...
  },
  {
    ...
    description:
      "No clearing, cleaning, or refurbishment required. We take the property exactly as we find it.",
  ...
  },
  {
    ...
    description:
      "We understand how probate sales work, the pressures on executors, and what solicitors need.",
  ...
  },
  {
    ...
    description:
      "You will always know where things stand. We do not disappear after making an offer.",
  ...
  },
  {
    ...
    description:
      "We do not charge fees to executors or solicitors. Our costs are ours to manage.",
...
export default function Features() {
  ...
  return (
    <section id="why" ref={ref} className="py-28 px-6 md:px-10">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map(({ icon: Icon, title, description, stat }) => (
            <div
              key={title}
              className="feature-card rounded-2xl p-6 border border-cream/8 transition-all duration-300 hover:border-clay/40 hover:scale-[1.02] group cursor-default"
            ...
            >
              ...
              <h3 className="font-sans font-600 text-cream text-base mb-2">
                {title}
              </h3>
              <p className="font-sans text-cream/50 text-sm leading-relaxed mb-4">
                {description}
              </p>
              <p className="font-mono text-clay text-xs tracking-wide opacity-70">
                → {stat}
              </p>
            </div>
          ))}
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mt-3 font-sans text-cream/30 text-xs">
            No obligation. Free of charge to the estate.
          </p>
        </div>
      </div>
    </section>
